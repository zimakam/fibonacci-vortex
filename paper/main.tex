...
\end{equation}
The generating function of the Fibonacci numbers, sum F_k x^k = x / (1 - x - x^2), has a pole at x = 1/phi, corresponding to r = r_c. This pole controls the behaviour of Gamma(r) in the core.
...
\end{equation}
with the universal constant c_inf ~ -0.0665, independent of Gamma_0 and r_c.
